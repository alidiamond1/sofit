  ...
  return (
    <Card className="service-card package-card managed-service-card">
      ...
      <div className="service-foot">
        ...
        <button className="button primary small" type="button" onClick={() => setAssigning(true)} disabled={!canAssign || clients.length === 0}><UserPlus size={14} /> {t("assignToClient")}</button>
      </div>
